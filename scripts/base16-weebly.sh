...
color08="9B/A0/A3" # Base 03 - Bright Black
...
color18="36/3B/3E" # Base 01
color19="66/6C/70" # Base 02
color20="C9/CD/CF" # Base 04
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 666C70 # selection color
